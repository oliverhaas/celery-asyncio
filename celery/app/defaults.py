...
class Option:
    ...
    def __repr__(self):
        return f"<Option: type->{self.type} default->{self.default!r}>"
...
def find_deprecated_settings(source):  # pragma: no cover
    ...
    for name, opt in flatten(NAMESPACES):
        # `is not None`, not truthiness: a deprecated bool explicitly set to
        # False is still a use of the deprecated setting (upstream 40c234919).
