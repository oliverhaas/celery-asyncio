...
--          -1 if dropped at the delivery limit
...
-- counting it again here would inflate delivery_count.
...
if restored then
    ...
    -- live reject loop, because every consume re-stamps the index deadline and
    -- the entry never comes due there, which is why the check runs here too.
