...
def second_order_replace1(self, state=False):
    ...
    if not state:
        ...
        new_task = chain(second_order_replace2.s(), second_order_replace1.si(state=True))
...
class ExpectedException(Exception):
    ...
    def __eq__(self, other):
        return other is not None and isinstance(other, ExpectedException) and self.args == other.args
