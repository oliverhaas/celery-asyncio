...
class test_default_logger:
    ...
    def test_setup_logger_no_handlers_file(self, *args):
        ...
        with patch("builtins.open") as osopen, conftest.restore_logging_context_manager():
            ...
            assert isinstance(conftest.get_logger_handlers(l)[0], logging.FileHandler)
    ...
    def test_logging_proxy(self, restore_logging):
        ...
        with conftest.wrap_logger(logger) as sio:
            ...
            with conftest.stdouts() as (stdout, stderr), in_sighandler():
                p.write("foo")
