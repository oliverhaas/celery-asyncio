...
class test_CursesDisplay:
    ...
    def test_format_row_with_default_widths(self):
        ...
        assert row == "783da208-77d0-40ca-b3d6-37dd6dbb55d3 workerworker... task.task.[.]tas 21:13:20 SUCCESS "
    ...
    def test_format_title_row(self):
        ...
        assert row == "UUID                      WORKER          TASK             TIME     STATE   "
    ...
    def test_format_row_for_wide_screen_with_short_uuid(self):
        ...
        assert len(row) == 136
        assert (
            row == "783da208-77d0-40ca-b3d6-37dd6dbb55d3 "
