...
from tests.smoke.tests.stamping.workers.legacy import *  # noqa
from tests.smoke.tests.stamping.workers.legacy import LegacyWorkerContainer
from tests.smoke.workers.dev import SmokeWorkerContainer
...
def default_worker_tasks(default_worker_tasks: set) -> set:
    from tests.smoke.tests.stamping import tasks as stamping_tasks
...
def default_worker_signals(default_worker_signals: set) -> set:
    from tests.smoke.tests.stamping import signals
