...
from tests.integration.conftest import get_redis_connection
from tests.integration.tasks import ExpectedException, add, fail, identity, redis_echo
...
class test_chord:
    ...
    def test_chord_error_propagation_with_different_body_types(self, celery_setup: CeleryTestSetup, input_body) -> None:
