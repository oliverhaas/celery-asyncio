...
from tests.smoke.operations.task_termination import TaskTermination
from tests.smoke.operations.worker_kill import WorkerKill
from tests.smoke.operations.worker_restart import WorkerRestart
from tests.smoke.workers.alt import *  # noqa
from tests.smoke.workers.dev import *  # noqa
from tests.smoke.workers.latest import *  # noqa
from tests.smoke.workers.other import *  # noqa
...
def default_worker_tasks(default_worker_tasks: set) -> set:
    ...
    from tests.integration import tasks as integration_tests_tasks
    from tests.smoke import tasks as smoke_tests_tasks
